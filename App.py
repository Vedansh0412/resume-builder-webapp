...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Vedansh@0412',db='RESUME_FEEDBACK')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="#" style="text-decoration: none; color: #021659;">JIIT STUDENTS</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="#" style="text-decoration: none; color: grey;">JIIT STUDENTS</a> 
