        ...
        <>
            <div id="form-collect">
                ...
                <div id="form-personal" className='mb-2'>
                    ...
                    <hr />
                    <Button onClick={handleEducationClick} className='my-3 w-100' colorScheme='green' variant='solid'>Add Education</Button>
                    {
                ...
                <div id="form-personal" className='mb-2'>
                    <div className='d-flex align-items-center justify-content-between'>
                        ...
                        <Switch defaultChecked={true} onChange={() => (setCheckProj(!checkProj))} colorScheme='green'  className='switch'/>
                    </div>
                    <hr />
                    <Button disabled={checkProj} onClick={handleProjectClick} className='my-3 w-100' colorScheme='green' variant='solid'>Add Projects</Button>
                    {
                ...
                <div id="form-personal" className='mb-2'>
                    <div className='d-flex align-items-center justify-content-between'>
                        ...
                        <Switch defaultChecked={true} onChange={() => (setCheckWork(!checkWork))} colorScheme='green'  className='switch'/>
                    </div>
                    <hr />
                    <Button disabled={checkWork} onClick={handleWorkClick} className='my-3 w-100' colorScheme='green' variant='solid'>Add Experience</Button>
                    {
                ...
                <div id="form-personal" className='mb-2'>
                    <div className='d-flex align-items-center justify-content-between'>
                        ...
                        <Switch defaultChecked={true} onChange={() => (setCheckAward(!checkAward))} colorScheme='green'  className='switch'/>
                    </div>
                    <hr />
                    <FormControl isRequired className='my-2'>
